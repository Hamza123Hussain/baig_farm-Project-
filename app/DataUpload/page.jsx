...
const Page = () => {
  ...
  const saveinfo_firestore = async () => {
    ...
    await setDoc(
      doc(db, 'Users', '70110719@student.uol.edu.pk', 'Cattle Data', docID),
      {
  ...
  return (
    <>
      ...
      user?.primaryEmailAddress.emailAddress ===
        ...
        // If the condition is not met, display this message
        <div className="text-center  flex justify-center min-h-screen flex-col gap-3 items-center">
